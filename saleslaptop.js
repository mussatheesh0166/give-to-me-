...
function insertNewRecord(data) {
    var table = document.getElementById("salesLaptopList").getElementsByTagName('tbody')[0];
...
function saveDataToLocalStorage() {
    ...
    localStorage.setItem("salesLaptopData", JSON.stringify(tableData));
}

function loadFromLocalStorage() {
    if (typeof (Storage) !== "undefined") {
        var savedData = JSON.parse(localStorage.getItem("salesLaptopData"));
