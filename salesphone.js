...
function insertNewRecord(data) {
    var table = document.getElementById("salesPhoneList").getElementsByTagName('tbody')[0];
...
function saveDataToLocalStorage() {
    ...
    localStorage.setItem("salesPhoneList", JSON.stringify(tableData));
}

function loadFromLocalStorage() {
    if (typeof (Storage) !== "undefined") {
        var savedData = JSON.parse(localStorage.getItem("salesPhoneList"));
