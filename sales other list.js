...
function insertNewRecord(data) {
    var table = document.getElementById("salesOtherList").getElementsByTagName('tbody')[0];
...
function saveDataToLocalStorage() {
    ...
    localStorage.setItem("salesOtherData", JSON.stringify(tableData));
}

function loadFromLocalStorage() {
    if (typeof (Storage) !== "undefined") {
        var savedData = JSON.parse(localStorage.getItem("salesOtherData"));
