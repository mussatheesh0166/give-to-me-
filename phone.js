...
function insertNewRecord(data) {
    var table = document.getElementById("purchasePhoneList").getElementsByTagName('tbody')[0];
...
function saveDataToLocalStorage() {
    ...
    localStorage.setItem("phoneData", JSON.stringify(tableData));
}

function loadFromLocalStorage() {
    if (typeof (Storage) !== "undefined") {
        var savedData = JSON.parse(localStorage.getItem("phoneData"));
