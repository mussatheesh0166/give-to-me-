...
function insertNewRecord(data) {
    var table = document.getElementById("otherList").getElementsByTagName('tbody')[0]; // Updated the ID to "otherList"
...
function saveDataToLocalStorage() {
    ...
    localStorage.setItem("otherData", JSON.stringify(tableData)); // Updated the key to "otherData"
}

function loadFromLocalStorage() {
    if (typeof (Storage) !== "undefined") {
        var savedData = JSON.parse(localStorage.getItem("otherData")); // Updated the key to "otherData"
